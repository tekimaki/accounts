...
if( !empty( $_REQUEST["save_subproject"] ) ) {
...
$gBitThemes->loadJavascript( ACCOUNTS_PKG_PATH.'scripts/BitSubProject.js', TRUE );


// Display the template
$gBitSystem->display( 'bitpackage:accounts/edit_subproject.tpl', tra('Edit Sub-Project') , array( 'display_mode' => 'edit' ));
